...
dbdom<-db %>% filter(plotA=="Y" | plotB=="Y") #only in treefall plot
...
write.csv(x = table1_adult,
          file = "figures/tableS1_adulttrees.csv", row.names = FALSE)
write.csv(x = table1_pole,
          file = "figures/tableS1_poletrees.csv", row.names = FALSE)
