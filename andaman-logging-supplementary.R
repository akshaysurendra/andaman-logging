...
write_csv(x = table1_both,
          path = "output/tableS1both_andaman-logging.csv")
write_csv(x = table1_adultsonly,
          path = "output/tableS1adult_andaman-logging.csv")
write_csv(x = table1_poleonly,
          path = "output/tableS1pole_andaman-logging.csv")
